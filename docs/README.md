...
| [roadmaps/28-plataforma-de-plugins-e-verticais.md](roadmaps/28-plataforma-de-plugins-e-verticais.md) | **Plataforma de plugins (`integration` v1) e as verticais**: C/C++/Rust sólidos, Docker como RemoteContext, banco de dados, embarcados — e a dívida contínua de UI/UX com o IntelliJ Community como referência adaptada |
