...
| [roadmaps/38-divida-restante-e-continuidade.md](roadmaps/38-divida-restante-e-continuidade.md) | **COMECE POR AQUI ao retomar** (2026-09-03): os 8 arquivos em débito com diagnóstico individual — um tem decisão registrada de ficar, três NÃO devem ser cortados —, o que já foi feito para não ser refeito, e o que está aberto |
