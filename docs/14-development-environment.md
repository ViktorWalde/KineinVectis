...
`docs/18-daily-driver-plan.md`), e termina verificando ferramenta por
...
vivem em `docs/21`, seção "M4.2". Detalhe do gancho `KINEIN_PERF_MARKER`
(marker env-gated na `main.cpp`, sem efeito no uso normal): `docs/18`,
"Fatia M4.2".
