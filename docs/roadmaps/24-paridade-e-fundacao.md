...
> rede de segurança (docs/seguranca/23). Princípio: **bugs de uso diário primeiro**
...
| **D4** | Convergência UI/UX (docs/roadmaps/20 + specs) | 🏗️ fundação | 🟢 C2/C3/C5 implementadas; C6 aguarda validação visual do usuário |
...
respeitar `docs/arquitetura/ARCHITECTURE.md`. Os harnesses `tst_assistant_layout`,
...
R0–R7 estão em `docs/roadmaps/26-terminal-rendering-parity-roadmap.md`.
...
O complemento semântico (`docs/roadmaps/KINEIN_VECTIS_DEEP_SEMANTIC_ENGINE_CPP_RUST_WORKFLOW.md`)
...
O design vinculante está em `docs/roadmaps/25-syntax-tree-semantic-foundation.md` e a
...
`docs/roadmaps/20` (fatias C0–C6). Por último: é o maior esforço e o dogfooding +
