...
5. SINCRONIZAR: docs/arquitetura/03 (contrato), docsprivate/diario/18 (checklist [feito] +
...
rajada PTY→frame. A fila executável e critérios estão em `docsprivate/PONTO_ATUAL.md`, A3.1
...
- Qualquer cópia do código entregue a terceiros contém, entre arquivos
  Markdown, somente README.md, MANUAL.md e Tutorial.md. docsprivate/GUIAIA.md,
  docsprivate/ContextoIA.md, docsprivate/PONTO_ATUAL.md, docsprivate/AGENTS.md, `docs/`, `prompts/`, roadmaps e
