...
2026-07-05 (ver `docs/arquitetura/15-engineering-debt-and-refactor.md` para o contexto da
...
enforcement geral — ver `docs/roadmaps/BACKEND_TO_UI_UX_ROADMAP.md` P1 "Risk engine").
...
`docs/roadmaps/KINEIN_VECTIS_OPEN_PLUGIN_ADAPTATION_ROADMAP.md`: registrar revisão e licença,
