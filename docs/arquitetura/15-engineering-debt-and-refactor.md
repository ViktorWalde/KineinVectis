...
> e documentada em `docs-legada/17-architecture-hygiene-plan.md`. Daqui para frente,
...
2. Decisões importantes podem ficar duplicadas ou divergentes entre docs
   numerados, planning, quality, subsystems e `docs-privada/ContextoIA.md`.
...
- manter `docs-privada/ContextoIA.md` como estado operacional, não como depósito infinito.
...
> foram extraídos para `docs/arquitetura/16-hidden-risks-checklist.md`. `docs-privada/ContextoIA.md`
...
- não deixar controller/store QML passar do gatilho de split definido em
  `docs-legada/17-architecture-hygiene-plan.md`;
