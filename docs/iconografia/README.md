...
[`../specs/KINEIN_VECTIS_VISUAL_SYSTEM_ICONS.md`](../specs/KINEIN_VECTIS_VISUAL_SYSTEM_ICONS.md).
...
01_SPECIFICATION/
    ...
    docs/00_ICON_SYSTEM_FOUNDATION.md     fundação (grade, traço, tokens)
    docs/01..07_*.md                      por área (views, ações, Git, build…)
    docs/08_QML_FRONTEND_ICON_CONTRACT.md contrato de consumo no QML
...
Detalhamento em `docs/01_FILE_SEMANTICS.md` (semântica),
`docs/02_ICON_VISIBILITY_AND_OPTICAL_SIZING.md` (sizing ótico),
`docs/03_QT_QML_IMPLEMENTATION.md` (implementação) e
`docs/04_VALIDATION_CHECKLIST.md` (checklist). Licença dos assets em
