// Deteccao de linguagem e as regras de realce por regex (fallback pre-LSP).
// Extraido de editor_highlighter.cpp em 2026-07-17 (Fase 1.4): "que linguagem e'
// este arquivo, e quais suas regras regex" e' um conceito proprio, e era o maior
// bloco do highlighter (rebuildRules, ~270 linhas). Mesma classe
// EditorHighlighter, metodos ja declarados no header — corpos movidos
// byte-a-byte, zero mudanca de logica.
