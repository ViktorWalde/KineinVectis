//! Persistência local em `SQLite` — rede de segurança de dados (DocsPublic/seguranca/23).
//!
...
//! sessão no futuro (P4 do DocsPublic/seguranca/23). DB corrompido/incompatível → recria (o
