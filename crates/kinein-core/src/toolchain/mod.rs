...
//! - `arguments`: a escolha expressa em argumentos de `cmake`/`clangd`;
//! - [`install`], [`import`], [`sysroot`]: o provedor de instalacao, o kit
//!   importado de um SDK e a leitura do sysroot (2026-09-13).
