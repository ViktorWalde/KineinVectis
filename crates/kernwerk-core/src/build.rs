...
use kernwerk_protocol::{BuildDiagnostic, BuildDiagnosticSeverity, ProjectKind};
...
#[cfg(test)]
mod tests {
    use kernwerk_protocol::BuildDiagnosticSeverity;
    ...
    fn ordinary_lines_are_not_diagnostics() {
        ...
        assert!(parse_gcc_like_line("Compiling kernwerk-core v0.1.0").is_none());
    }
