...
- Filosofia inalterada (docsprivate/AGENTS.md): orquestrar ferramentas maduras, nunca
...
[feito] docsprivate/diario/18 + docsprivate/ContextoIA.md         notas antigas corrigidas, fatia
                                        marcada
```
...
[feito] MANUAL.md + docsprivate/ContextoIA.md              atual seção 5; estado
```
...
docsprivate/diario/18 (esta nota); ContextoIA (M4 quase fechado).
...
3. Entregar com gate verde + smoke, atualizar docsprivate/ContextoIA.md e este doc
