...
> 24 horas.
>
> **Estado vivo:** `docsprivate/PONTO_ATUAL.md` (fila) e `docsprivate/GUIAIA.md` (mapa) — e os dois se
> curvam ao codigo. **Contrato:** `docsprivate/AGENTS.md` + `docs/arquitetura/ARCHITECTURE.md`.
...
- **Documentacao reorganizada por assunto** (sessao autonoma, sem commit): os
  ...
  `docsprivate/PLANO_ORGANIZACAO_E_HANDOFF.md` (nao publicar).
...
- Protocolo IPC atual: `0.59.0` (2026-07-16). **0.59 REMOVE o dominio
  ...
  essa lista aqui).
- Formatacao orquestrada (fatia M1.1 de `docsprivate/diario/18-daily-driver-plan.md`,
  ...
  saves descarta respostas obsoletas. Design completo e decisoes: docsprivate/diario/18.
...
- QML (desde 2026-07-08): qmllint estrito (zero warnings) no gate via
  ...
  rigor: `docsprivate/diario/18-daily-driver-plan.md`.
...
- **A UI atual NAO reflete docs/specs/** (paleta, dimensoes, iconografia,
  ...
  docsprivate/diario/18. Nenhum agente deve tratar a aparencia atual como referencia — a
  referencia e a spec.
...
4. **TAREFA CONCLUIDA EM 2026-07-06:** quebrar `Main.qml` (~4600 linhas
   ...
   **Proxima sequencia recomendada apos este checkpoint/commit (2026-07-06;
   ...
   4. [em andamento] Seguir `docsprivate/diario/18-daily-driver-plan.md` (criado 2026-07-08
      ...
      generic, builtinType, etc. Design/decisoes: docsprivate/diario/18, "Fatia M1.2".
      ...
      hover/completion. Design: docsprivate/diario/18, "Fatia M1.3".
      ...
      linha/coluna. Validada e2e com rust-analyzer real. Design: docsprivate/diario/18,
      "Fatia M1.4".
      ...
      processos do core. Design: docsprivate/diario/18, "Fatia M1.5".
      ...
      Design: docsprivate/diario/18, "Fatia M1.6".
      ...
      **M2 estruturado em docsprivate/diario/18** (ordem: M2.1 terminal unificado ->
      ...
      sessao. A atual seção 5 do MANUAL documenta o fluxo. Design: docsprivate/diario/18,
      "Fatia M2.1".
      ...
      docsprivate/diario/18: regiao 1 (Title/App Bar) so nasce na C5; Target/Profile
      ...
      **M2 FECHADO**: debug.stackTrace (20 frames) e debug.variables
      ...
      estruturada em docsprivate/diario/18: E1 auto-close de pares → E2 Enter
      ...
      de span de linhas) e design: docsprivate/diario/18, "Fatia E3".
      ...
      .kinein/build; reconfigure ao salvar CMakeLists; docsprivate/diario/18).
      ...
      **docs/roadmaps/21-long-horizon-roadmap.md** (pedido do usuario: qualidade
      ...
      git real. Design: docsprivate/diario/18, "Fatia M3.4".
      ...
      docsprivate/diario/18, "Fatia T1".
      **M3 validado tecnicamente (gate verde + sondas e2e); falta o
      ...
      proprio sem QtQuick.Controls): docsprivate/diario/18, "Fatia T6". Pendente:
      ...
      analyzer JA estao prontos. Design/descobertas: docsprivate/diario/18, "Fatia
      ...
      antes de sondas e2e. Design: docsprivate/diario/18, "Fatia M4.1".
      ...
      **M4.3 parte A (recuperacao de crash do core) FEITA em 2026-07-11**
      ...
      M4.3b. Design: docsprivate/diario/18 "Fatia M4.3".
      **M4.5 (perfis de rigor Strict/Balanced/Relaxed) FEITA em
      ...
      real; perfil so afeta Rust no v1). Design: docsprivate/diario/18 "Fatia M4.5".
      **M4.2 (orcamento de performance) FEITA em 2026-07-11, protocolo
      ...
      de .rs ja dispara did_open -> LSP sobe sozinho. Design: docsprivate/diario/18
      "Fatia M4.2".
      **M4.3b (lsp.restart + jobs orfaos) FEITA em 2026-07-11, protocolo
      ...
      deixa cargo orfao. Design: docsprivate/diario/18 "Fatia M4.3b".
...
- `docsprivate/GUIAIA.md` é o roteador operacional vivo entre documentação e código:
...
- Após A1/A2, a próxima funcionalidade de produto é **responsividade medida**;
  a ordem viva está somente em `docsprivate/PONTO_ATUAL.md`.
...
- O gatilho **“estou no Kinein”** foi recebido; self-hosting/dogfooding está
  ATIVO. `docsprivate/PONTO_ATUAL.md` já registra a transição e permanece a fila viva.
...
- Com A1/A2 entregues, seguir responsividade medida e os confortos exigidos por
  ...
  `docsprivate/PONTO_ATUAL.md`, `docs/roadmaps/21-long-horizon-roadmap.md` e os docs de domínio já
  são a fila.
...
- A baseline release de A3 foi revalidada com `N=3`: primeiro frame 250 ms,
  ...
  foram detalhadas em `docsprivate/PONTO_ATUAL.md`, reutilizando os scripts M4.2. Code OSS
...
- O dogfooding registrou `docsprivate/imagens/bugs/ReformularBarra.png`: a decoração
...
- Licença MIT OR Apache-2.0 (mesma expressão do projeto); metáforas próprias, sem
  ...
  `docsprivate/GUIAIA.md` §3.2 e §5.2.

## Escalonamento linear das integrações solicitadas (2026-07-15)

- Os 53 candidatos de `docsprivate/PONTO_ATUAL.md` A5 foram tirados da categoria vaga de
...
- E6 fechada no mesmo dia: o type-over do auto-close passou a respeitar a
  ...
  engolido. Registro completo: `docsprivate/diario/18`, fatias E1b/E6.
...
- **Achado ao executar:** "obrigatório" JÁ estava escrito. O `docsprivate/AGENTS.md` dizia,
...
- Por isso a mudança não foi reforçar o adjetivo, e sim: (a) tirar a regra de
  item 3 de uma lista e dar seção própria no topo do `docsprivate/AGENTS.md`, com os números
...
- Marcado em todos os pontos de entrada: `docsprivate/AGENTS.md` (seção nova no topo + item
  3), `docs/README.md` (índice), `docsprivate/GUIAIA.md` (roteiro e ordem de leitura),
...
- Marcado em `docsprivate/AGENTS.md`, `ARCHITECTURE.md` §1.3, `docsprivate/GUIAIA.md`.
...
- Decisão do autor: remake do ícone principal (500x500 -> 1254x1254) e, em
  ...
  em `docsprivate/imagens/prints`. A janela já é frameless com chrome próprio, então isso é
...
- Rename fechado (§0.2d-2). Nome do autor: **Assistente**. Foi ate os internos e
  os docs vivos; `docsprivate/ContextoIA.md`, `docsprivate/diario/` e ADR-0004 ficaram com o nome da
