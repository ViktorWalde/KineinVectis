...
> **Entrada atual:** [`../docsprivate/AGENTS.md`](../docsprivate/AGENTS.md).
...
```text
docsprivate/AGENTS.md          regras obrigatórias e ordem de leitura
docsprivate/ContextoIA.md      estado real e decisões vigentes
docsprivate/GUIAIA.md          mapa: domínio → documentos → arquivos → gate
docsprivate/PONTO_ATUAL.md     fila viva: a próxima ação executável
