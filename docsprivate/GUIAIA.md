...
> **Não substitui:** `docsprivate/ContextoIA.md`, `docs/arquitetura/ARCHITECTURE.md`, specs ou contrato
...
1. `docsprivate/ContextoIA.md` — estado real, decisões vigentes e restrições do produto.
2. Este `docsprivate/GUIAIA.md` — descubra o domínio e os arquivos conectados.
...
4. `docsprivate/PONTO_ATUAL.md` — próxima tarefa executável e ordem vigente.
...
```text
docsprivate/ContextoIA.md + código real
        ↓
docs/specs/ (visão-alvo e UI/UX não negociável)
        ↓
docs numerados (contrato/estado implementado)
        ↓
docsprivate/PONTO_ATUAL.md (ordem de execução)
        ↓
docsprivate/GUIAIA.md (mapa; nunca sobrepõe as fontes acima)
```
...
- Fonte: `docsprivate/PONTO_ATUAL.md`, seção de validação ao vivo.
...
ativação, ler o handoff da seção 0 de `docsprivate/PONTO_ATUAL.md` e aguardar o primeiro
feedback real. Se não houver bloqueio e o usuário pedir continuidade do
roadmap, seguir a fila viva de `docsprivate/PONTO_ATUAL.md`; depois de A1/A2, a próxima
...
3. docsprivate/PONTO_ATUAL.md A5.1–A5.3            nível aberto? decisão do candidato?
...
```text
1. docsprivate/PONTO_ATUAL.md §0 (dogfooding) e A4  o atrito já foi registrado?
...
```text
1. docsprivate/PONTO_ATUAL.md §0                   registrar ação/esperado/observado/ambiente
...
4. docsprivate/PONTO_ATUAL.md                       a fatia está na fila? em que nível?
```
...
2. docsprivate/PLANO_ORGANIZACAO_E_HANDOFF.md       faixas P/T/X e o que já foi executado
...
| --- | --- | --- |
| Qual é o estado real agora? | `docsprivate/ContextoIA.md` | `docsprivate/PONTO_ATUAL.md` |
| Qual é a próxima tarefa? | `docsprivate/PONTO_ATUAL.md` | `docs/roadmaps/21-long-horizon-roadmap.md` |
...
| Daily driver e dogfooding | `docsprivate/diario/18-daily-driver-plan.md` | `docs/roadmaps/21-long-horizon-roadmap.md` |
...
| Entrega sanitizada do código | M7 de `docs/roadmaps/21-long-horizon-roadmap.md` | `Tutorial.md` + item correspondente de `docsprivate/PONTO_ATUAL.md` |
...
| `docsprivate/AGENTS.md` | regras obrigatórias para agentes de terminal |
| `docsprivate/ContextoIA.md` | decisões vigentes, histórico operacional útil e estado real |
| `docsprivate/PONTO_ATUAL.md` | fila explícita e critérios imediatos de aceite |
| `docsprivate/GUIAIA.md` | este mapa entre conhecimento, módulo, arquivo e gate |
...
- Fontes: spec Build/Run/Debug, `docs/build/22-compilacao-c-cpp-rust.md`,
  `docsprivate/diario/18-daily-driver-plan.md` e `docs/roadmaps/21-long-horizon-roadmap.md`.
...
7. `docs/arquitetura/03-ipc-protocol.md`, schema aplicável e `docsprivate/ContextoIA.md`.
...
- `docsprivate/GUIAIA.md`, `docsprivate/ContextoIA.md`, `docsprivate/PONTO_ATUAL.md`, `docsprivate/AGENTS.md`, `docs/`,
...
Atualize `docsprivate/GUIAIA.md` quando ocorrer qualquer um destes eventos:
...
```text
[ ] docsprivate/ContextoIA.md representa o estado real?
[ ] docsprivate/PONTO_ATUAL.md aponta a próxima ação, não trabalho já encerrado?
[ ] docsprivate/GUIAIA.md ainda leva ao domínio e aos arquivos corretos?
