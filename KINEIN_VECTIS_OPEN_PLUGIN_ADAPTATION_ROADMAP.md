...
Antes de instalar, clonar, portar ou adaptar qualquer item, a IA deve verificar:
...
# 7. Procedimento para a IA fazer a varredura

A IA deve trabalhar item por item.
