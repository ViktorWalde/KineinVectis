...
A UI/UX implementada hoje **não reflete `DocsPublic/especificacoes/`**. Ela nasceu como MVP
...
```text
1. A arquitetura já separou visual de lógica (DocsPublic/arquitetura/17): componentes QML
...
| Área | Spec canônica |
| --- | --- |
| Layout/regiões/dimensões | `sistema-de-layout.md` |
| Paleta/tipografia/ícones | `sistema-visual-e-icones.md` |
| Componentes (botões, tabs, listas...) | `sistema-de-componentes-de-ui.md` |
| Fluxos build/run/debug | `fluxos-de-produto-build-run-debug.md` |
| Editor/inteligência | `editor-e-inteligencia-de-linguagem.md` |
| Onboarding/start/wizard | `KINEIN_VECTIS_ONBOARDING_*.md` |
| Índice geral | `indice-das-especificacoes.md` |
...
`sistema-de-layout.md`; `VISUAL` =
`sistema-visual-e-icones.md`; `COMP` =
