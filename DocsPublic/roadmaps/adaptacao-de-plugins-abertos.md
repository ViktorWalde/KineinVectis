...
```text
DocsPublic/decisoes-adr/ADR-XXXX-<component>.md
```
...
> item a item e dependências L0–L10, está em `DocsPrivate/historico/PONTO_ATUAL.md` A5.1–A5.4. Essa
...
```text
1. Criar registro-de-componentes-abertos.json.
