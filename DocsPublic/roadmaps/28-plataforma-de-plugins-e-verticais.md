...
> **Classe: PLANO** (`DocsPublic/README.md`). Descreve o **alvo**; diverge da
...
> ele pediu no framework que já existe (`DocsPublic/integracoes/README.md` — modos A–D,
...
> antecipa a integração dela. (`DocsPublic/integracoes/README.md`)
...
Já especificado (tabela L0–L10 e `DocsPublic/especificacoes/embarcados-targets-flash-serial-qemu.md`).
