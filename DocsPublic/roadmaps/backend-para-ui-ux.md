...
Este arquivo nao substitui `DocsPublic/especificacoes/`. Quando houver duvida de produto,
layout, interacao ou sistema visual, a fonte alvo continua sendo:

```text
DocsPublic/especificacoes/indice-das-especificacoes.md
DocsPublic/especificacoes/sistema-de-layout.md
DocsPublic/especificacoes/sistema-de-componentes-de-ui.md
DocsPublic/especificacoes/sistema-visual-e-icones.md
DocsPublic/especificacoes/fluxos-de-produto-build-run-debug.md
DocsPublic/especificacoes/editor-e-inteligencia-de-linguagem.md
DocsPublic/especificacoes/arquitetura-interna-core-ipc-jobs.md
DocsPublic/especificacoes/recursos-sob-demanda-estrategia-de-performance.md
```
...
```text
recursos-sob-demanda-estrategia-de-performance.md
arquitetura-interna-core-ipc-jobs.md
fluxos-de-produto-build-run-debug.md
```
...
## Sequencia recomendada (revisada em 2026-07-05 para nao atrasar o Qt)
...
6. [etapa 1 feita em 2026-07-08] Project Health minimo e visivel:
   ...
   - [pendente] se faltar dado real, criar `project.health` tipado no
     protocolo, handler fino no core, testes, DocsPublic/arquitetura/03 e UI discreta. Se for
...
- A UI obedece DocsPublic/specs e nao dirige regra de negocio.
- Uma entrega so fecha com este roadmap sincronizado.
```
