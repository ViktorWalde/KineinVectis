...
AMD Ryzen 7 7735HS (16 threads), ~22 GB RAM, Arch, Qt 6.11 (DocsPublic/build/14). O
...
- Escopo: Start Screen (projetos recentes — persistir lista global no
  ...
  Health). A UI segue as specs de DocsPublic/especificacoes/ONBOARDING_*.
...
- Esta fatia é de DESIGN + medição; o resultado é um doc de decisão
  (DocsPublic/2x) com a escolha e o plano, não código.
```
...
chamando a MESMA ferramenta madura, e (c) UI burra conforme DocsPublic/specs.
...
8. C5/C6 de DocsPublic/roadmaps/20 intercaladas (convergência visual termina no M4);
