...
```text
Implemente a Parte 4 da Kinein Vectis com foco em fluxos de produto para Toolchain, CMake, Build, Run e Debug. Siga o documento fluxos-de-produto-build-run-debug.md como fonte de verdade.
