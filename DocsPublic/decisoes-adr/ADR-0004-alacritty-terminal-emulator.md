...
Evidência complementar (`DocsPublic/roadmaps/26` §4.4): no modo de transcript plano o
...
- **Reordena o R3 de `DocsPublic/roadmaps/26`:** a decisão de *emulador* precede a de
...
- [x] Registrar o componente em `DocsPublic/integracoes/registro-de-componentes-abertos.json`
