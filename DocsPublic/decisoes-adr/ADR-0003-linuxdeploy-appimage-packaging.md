...
e verificados pelos SHA256 registrados em `registro-de-componentes-abertos.json`. O
...
AppImage, `.AppImage.sha256`, `instalar-kinein-vectis.sh` e `DocsPublic/tutorial.md`. O
...
distribuição para `DocsPublic/tutorial.md` e deixou o `DocsPublic/manual.md` empacotado restrito ao
...
6. `dist/` conter AppImage, checksum específico, instalador e `DocsPublic/tutorial.md`
   idêntico à fonte;
