...
**139 métodos IPC** roteados e **48 eventos**, em **34 domínios de protocolo**;
**708 testes** Rust verdes e **32 harnesses QML** (remedido em 2026-09-13;
em 2026-09-12 à noite a simulação saiu do produto: −11 métodos, −85 testes,
−7 harnesses). Protocolo `0.106.0`. O gate tem **23 verificações** — a vigésima (2026-09-11)
